...
namespace Application.Features.Authenticate.Commands.AuthenticateCommand
{
    ...
    public class AuthenticateResponse : IRequestHandler<AuthenticateCommand, Response<AuthenticationResponse>>
    {
        private readonly IAccountService _accountService;

        public AuthenticateResponse(IAccountService accountService)
        {
